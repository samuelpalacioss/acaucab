...
(350, 1, 11, 6),     /** Rogue American Amber - Botella 330ml **/
(280, 2, 12, 6),     /** La Chouffe - Botella 500ml **/
(450, 3, 13, 7),     /** Orval - Lata 330ml **/
(180, 4, 14, 7),    /** Chimay - Six-pack 330ml **/
(120, 5, 15, 8),   /** Leffe Blonde - Caja 24 unidades 330ml **/
(80, 6, 16, 8),       /** Hoegaarden - Barril 20L **/
(40, 7, 17, 9),       /** Pilsner Urquell - Barril 30L **/
(25, 8, 18, 9);       /** Samuel Adams - Barril 50L **/
...
INSERT INTO orden_de_reposicion (
    ...
    ('2025-01-10', 'Reposición urgente', 50, 1, 1, 1, 1, 1, 1),      /** Reposición botellas 330ml en anaquel 1 */
    ('2025-01-11', 'Stock bajo', 30, 2, 1, 2, 2, 1, 2),              /** Reposición botellas 500ml en zona 2 */
    ('2025-01-12', 'Para promoción', 60, 3, 1, 3, 3, 2, 3),          /** Reposición latas 330ml en anaquel 3 */
    ('2025-01-13', 'Pedido regular', 20, 4, 2, 4, 4, 2, 4),         /** Reposición six-packs en zona 4 */
    ('2025-01-14', 'Falta stock', 15, 5, 2, 5, 5, 3, 5),           /** Reposición cajas en anaquel 5 */
    ('2025-01-15', 'Reposición mensual', 10, 6, 2, 6, 6, 3, 1),       /** Reposición barriles 20L en zona 6 */
    ('2025-01-16', 'Stock mínimo', 5, 7, 3, 7, 7, 4, 2),              /** Reposición barriles 30L en pasillo 7 */
    ('2025-01-17', 'Pedido especial', 3, 8, 3, 8, 8, 4, 3),           /** Reposición barriles 50L en zona 8 */
    ('2025-01-18', 'Reposición semanal', 25, 9, 3, 9, 9, 5, 4),       /** Reposición growlers en anaquel 9 */
    ('2025-01-19', 'Stock temporada', 40, 10, 4, 10, 10, 5, 5);     /** Reposición cajas en pasillo 10 */
