 ...
 */
export default function NuevoUsuarioClient({ personasDisponibles, roles }: NuevoUsuarioClientProps) {
  ...
  const uniquePermissions = rolePermissions.filter(
    (permission, index, self) =>
      permission.permiso_id !== null && index === self.findIndex((p) => p.permiso_id === permission.permiso_id)
  );

  return (
    <ProtectedRoute requiredPermissions={["crear_usuario"]} redirectTo="/unauthorized">
      ...
      */}
        <div id="nuevo-usuario-header" className="flex items-center justify-between">
          ...
          <Button onClick={handleCreateUser} id="crear-usuario-button" disabled={!canCreateUser || isCreatingUser}>
            {isCreatingUser ? (
              <>
        ...
        <div id="creation-grid" className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card id="seleccion-persona-card">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-sm text-gray-600">{filteredPeople.length} personas encontradas</div>
              ...
              <div id="personas-list" className="space-y-2 max-h-64 overflow-y-auto">
                ...
                {filteredPeople.length === 0 && (
                  <div className="text-center py-4 text-gray-500">No se encontraron personas con ese criterio</div>
                )}
              </div>
              ...
              <div id="resumen-grid" className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div id="resumen-persona">
                  ...
                  <div id="resumen-persona-email" className="text-sm text-gray-600">
                    ...
                    {!selectedPerson.email && newUser.newEmail && <span className="text-green-600 ml-1">(Nuevo)</span>}
                  </div>
                </div>
