-- Primero, eliminamos el trigger y la función si ya existen para evitar errores.
...
-- Creamos la función que se ejecutará con el trigger.
...
-- Finalmente, creamos el trigger en la tabla 'status_venta'.
