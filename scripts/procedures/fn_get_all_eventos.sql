...
BEGIN
  RETURN QUERY
  SELECT e.id id, e.nombre nombre, e.dirección direccion, t.nombre tipo, e.fecha_hora_inicio fecha_inicio, e.fecha_hora_fin fecha_fin, e.precio_entrada precio_entrada,
