...
export const events = [
  ...
  {
    id: 4,
    title: "Cerveza y Jazz",
    description: "Noche de jazz en vivo acompañada de las mejores cervezas artesanales",
    image: "/placeholder.svg?height=200&width=400",
    location: "Centro Cultural Chacao",
    date: "8 de Junio",
    time: "7:00 PM - 11:00 PM",
    capacity: 120,
    notes: "Entrada con reservación previa",
    marcas: ["ACAUCAB", "Ávila", "Del Sol"],
    direccion: "Av. Principal de Chacao, Caracas",
    categorias: ["Música", "Cerveza", "Cultura"],
    precio: 8,
  },
];
